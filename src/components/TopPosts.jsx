...
export default function TopPosts() {
  ...
  return (
    <section id="top-posts" className="py-12 sm:py-16 bg-slate-950 text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">Top Posts</h2>
          <p className="text-blue-200/80 mt-2 text-sm sm:text-base">New campaigns appear here as a public post, visible to all connected accounts.</p>
        </div>
